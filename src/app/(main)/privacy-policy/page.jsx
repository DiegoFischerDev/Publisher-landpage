    ...
    <div className="flex justify-center bg-white px-6 py-40 lg:px-8 lg:py-52">
      <div className="w-[90%] max-w-4xl text-base text-gray-700">
        ...
        <p className="text-base font-semibold text-[#06b6d4]">
          NicePeopleAtWork S.L. is committed to
        ...
        <div className="mt-10">
          ...
          <ul role="list" className="mt-8 space-y-8 text-gray-600">
            ...
            <li className="gap-x-3">
              ...
              <p>
                ...
                <Link href="/cookie-policy">
                  <span className="font-bold text-[#06b6d4]">here</span>
                </Link>
              </p>
            </li>
            <li className="gap-x-3">
            ...
            <li className="gap-x-3">
              <p>
              At any time you may revoke the consent to use your information and/or exercise the above rights, for free, by emailing us at <strong>dataprotection@nicepeopleatwork.com</strong> or at <strong>C/ Roc Boronat 23, 08005, Barcelona</strong> or calling at <strong>(+34) 93 122 21 11</strong>.
              </p>
            </li>
          </ul>
        </div>
