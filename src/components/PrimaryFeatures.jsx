    ...
    <AppScreen className="w-full">
      ...
      >
        <div className="px-4 py-6">
          ...
          <div className="mt-6 rounded-lg bg-color2 px-3 py-2 text-center text-sm font-semibold text-white">
            Invite person
          </div>
        </div>
      </MotionAppScreenBody>
      ...
      >
        <div className="px-4 py-6">
          <div className="space-y-4">
            ...
            <div className="rounded-lg bg-color2 px-3 py-2 text-center text-sm font-semibold text-white">
              Buy shares
            </div>
          </div>
        </div>
